...
public class Dashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        btnBeranda.setBackground(new java.awt.Color(46, 78, 110));
        ...
        btnMahasiswa.setBackground(new java.awt.Color(22, 47, 79));
        ...
        btnMataKuliah.setBackground(new java.awt.Color(22, 47, 79));
        ...
        btnNilai.setBackground(new java.awt.Color(22, 47, 79));
        ...
        btnDosen.setBackground(new java.awt.Color(22, 47, 79));
...
btnLogout.setForeground(Color.WHITE);
   ...
   private void styleNavHover(JButton btn) {
    ...
    btn.getModel().addChangeListener(e -> {
        if (btn == getActiveButton()) {
            btn.setBackground(new Color(46, 78, 110));
   ...
   private JButton getActiveButton() {
    if (btnBeranda.getBackground().equals(new Color(46, 78, 110))) return btnBeranda;
    if (btnMahasiswa.getBackground().equals(new Color(46, 78, 110))) return btnMahasiswa;
    if (btnMataKuliah.getBackground().equals(new Color(46, 78, 110))) return btnMataKuliah;
    if (btnNilai.getBackground().equals(new Color(46, 78, 110))) return btnNilai;
    if (btnDosen.getBackground().equals(new Color(46, 78, 110))) return btnDosen;
    return null;
}
